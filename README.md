...
| ----------------------------------------------------------------------- | ------------ | --------- | -------------------------- | ------------------------------------------------------------------- |
| [cluster_dbx_parquet.py](benchmarks/cluster_dbx_parquet.py)             | 266.7s       | Cluster   | Databricks Connect (Spark) | `/Workspace/Users/{USER}@forhims.com/swolness_pamphlet/assignments` |
| [cluster_dbx_unity_catalog.py](benchmarks/cluster_dbx_unity_catalog.py) | 30.8s         | Cluster   | Databricks Connect (Spark) | `{CATALOG}.default.swolness_cluster_dbx_uc`                         |
| [warehouse_sql_download.py](benchmarks/warehouse_sql_download.py)       | 688.7s       | Warehouse | SQL Connector              | download to my laptop                                               |
| [cluster_sql_new_table.py](benchmarks/cluster_sql_new_table.py)         | 23.9s         | Cluster   | SQL Connector              | `{CATALOG}.default.swolness_cluster_sql_new`                        |
| [cluster_sql_delta_table.py](benchmarks/cluster_sql_delta_table.py)     | 28.2s         | Cluster   | SQL Connector              | `{CATALOG}.default.swolness_cluster_sql_delta`                      |
